...
everything is tagged `Project=opencv26` and `Product=scopewatch`. Set `DRY_RUN=1` to see the
...
infra/apprunner.sh scopewatch                 # prints https://<id>.awsapprunner.com
infra/apprunner.sh scopewatch --status
```
